...
export const creativeItems: CreativeItem[] = [
  ...
  { section: "creative", id: "dragon", title: "Dragon", date: "Ongoing", labels: ["Creature", "Object"], practice: "Crochet", materials: ["Yarn"], description: "A small creature from an expanding handmade menagerie.", image: "/images/creative/dragon.jpeg" },
